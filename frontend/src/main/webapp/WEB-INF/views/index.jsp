...
<div id="progress_window">
    <ol id="progress_steps">
        <li id="progress_step_0" class="progress_step_past progress_step_active"><h3><spring:message
                code="front.progress.step0"/></h3></li>
...
<div id="content_wrapper">
    ...
    <form:form commandName="FORM" id="whoWhenRequestForm" enctype="multipart/form-data"
               action="http://data.${domainPath}/?redirect=http://${servletPath}" method="POST">
        <div id="step_wrapper1" class="step_wrapper" style="display: none;">
            ...
            <div class="step_content">
                ...
                <div class="info_window">
                    <div id="metro-pivot11" class='metro-pivot'>
                        ...
                        <div class='pivot-item'>
                            ...
                            <p><spring:message code="front.step1.maxsize"/>: <c:out
                                    value="${maxUploadFileSize/1000000}"/>MB</p></br>
                ...
                <div id="step_1_ok" class="button" style="display: none;" onclick="levelAction(1,true);"><spring:message
                        code="front.step1.submit"/></div>
        ...
        <div id="step_wrapper2" class="step_wrapper" style="display: none;">
            ...
            <div class="step_content">
                    ...
                    <div id="metro-pivot2" class='metro-pivot'>
                        <div class='pivot-item'>
                            ...
                            <ul class="processing_parameters">
                                <li><form:label path="email"><spring:message
                                        code="front.step2.label.email"/>:</form:label><form:input path="email"/></li>
                                <li><form:label path="speakersCount"><spring:message code="front.step2.label.speakers"/>:</form:label><form:input
                                        path="speakersCount"/></li>
                            </ul>
                        </div>
                        <div class='pivot-item'>
                            <h3><spring:message code="front.step2.menu.info"/></h3>
                            <ul class="processing_parameters">
                                <li><spring:message code="front.step2.label.email"/> :<br/> <spring:message
                                        code="front.step2.menu.info.content.email"/></li>
                                <li><spring:message code="front.step2.label.speakers"/> :<br/> <spring:message
                                        code="front.step2.menu.info.content.speakers"/></li>
                            </ul>
                        </div>
                    </div>
                    <script type="text/javascript">
                ...
                <div id="step_2_parameters">
                    <div class="clear_both"></div>
                    <div id="step_2_ok" class="button" onclick="levelAction(2,true);"><spring:message
                            code="front.step2.submit"/></div>
                    <div class="clear_both"></div>
                </div>
            </div>
        </div>
...
&ndash;%&gt;
        ...
        <div id="step_wrapper3" class="step_wrapper" style="display: none;">
            ...
            <div class="step_content">
                ...
                <div class="step_info"></div>
                <div onclick="$('#whoWhenRequestForm').submit()" class="button" style="font-size: 3em;"><spring:message
                        code="front.step4.submit"/></div>
            </div>
        </div>
    </form:form>
    <mytags:footer/>
