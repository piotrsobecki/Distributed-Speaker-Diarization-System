...
public abstract class MeanCalculator {
    ...
    public static double calculateMean(double[] input, MeanMethod method){
        ...
        switch (method){
            case ARITHMETIC: return calculateArithmeticalMean(input);
            case GEOMETRIC: return calculateGeometricMean(input);
            case HARMONIC: return calculateHarmonicMean(input);
        }
        return Double.NaN;
    }
